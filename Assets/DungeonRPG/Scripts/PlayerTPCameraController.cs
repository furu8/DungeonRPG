...
public class PlayerTPCameraController : MonoBehaviour {
    ...
    [SerializeField] private float mouseXSensitivity = 1.0f; // マウス（コントローラ）X軸のセンシ
    [SerializeField] private float mouseYSensitivity = 1.0f; // マウス（コントローラ）Y軸のセンシ
